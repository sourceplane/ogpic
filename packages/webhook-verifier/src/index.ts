 ...
 * signature verifier for Ogpic outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Ogpic webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Ogpic webhook delivery.
 *
