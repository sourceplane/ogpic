 ...
 * signature verifier for Lumen outbound webhook deliveries.
 *
...
/**
 * Compute the canonical Lumen webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a Lumen webhook delivery.
 *
