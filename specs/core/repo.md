...
- The approved Supabase organization is `ogpic` with slug/id
...
- Supabase Auth, Realtime, Storage, and Edge Functions are not platform source-of-truth services unless a future spec explicitly adopts them. Ogpic-owned identity remains in the identity component.
...
- This repo consumes the `sourceplane/ogpic` GitHub OIDC roles and
