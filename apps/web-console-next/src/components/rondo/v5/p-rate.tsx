        ...
        <div style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
          <div style={{ flex: 1, margin: "14px 20px 0", background: C5.card, border: `1px solid ${ink(0.1)}`, borderRadius: 22, padding: 20, display: "flex", flexDirection: "column", minHeight: 0, overflowY: "auto" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 13 }}>
              <div style={{ width: 52, height: 52, borderRadius: "50%", background: C5.sage, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 700, color: C5.ink, flex: "none" }}>
                {t.initials}
              </div>
              ...
              <span style={{ fontFamily: MONO, fontSize: 10, fontWeight: 600, padding: "5px 10px", borderRadius: 12, background: "rgba(var(--rk-green-rgb),.1)", color: C5.green }}>OVR {t.ovr}</span>
            </div>
            ...
            <div
              onClick={saveAndNext}
              style={{ height: 50, borderRadius: 15, background: C5.ink, color: C5.onInk, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13.5, fontWeight: 700, cursor: "pointer", flex: "none" }}
            >
              Save &amp; next →
            </div>
          </div>
